...
export function parse (argv, options) {
  if (!Array.isArray(argv)) throw new Error('Expected to receive the arguments array.')
  if (!Array.isArray(options)) throw new Error('Expected to receive the options object.')
